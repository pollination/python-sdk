...
from pollination_sdk.models.invoice_list import InvoiceList  # noqa: E501
...
class TestInvoiceList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = pollination_sdk.models.invoice_list.InvoiceList()  # noqa: E501
        if include_optional :
            return InvoiceList(
                has_more = True, 
                resources = [
                    pollination_sdk.models.invoice.Invoice(
                        auto_advance = True, 
                        collection_method = '0', 
                        currency = '0', 
                        customer = '0', 
                        description = '0', 
                        discounts = [
                            pollination_sdk.models.discount.Discount(
