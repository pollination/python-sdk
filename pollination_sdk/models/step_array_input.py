...
class StepArrayInput(object):
    ...
    def __init__(self, alias=None, annotations=None, default=None, description=None, items_type='String', name=None, required=False, spec=None, type='StepArrayInput', value=None, local_vars_configuration=None):  # noqa: E501
