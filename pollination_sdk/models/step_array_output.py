...
class StepArrayOutput(object):
    ...
    def __init__(self, annotations=None, description=None, items_type='String', name=None, path=None, type='StepArrayOutput', value=None, local_vars_configuration=None):  # noqa: E501
