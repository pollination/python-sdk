...
class LicensePoolPublic(object):
    ...
    """
    openapi_types = {
        'accessors': 'list[LicensePoolAccessPolicy]',
        'description': 'str',
        'id': 'str',
        'license_id': 'str',
        'owner': 'AccountPublic',
    ...
    def __init__(self, accessors=[], description=None, id=None, license_id=None, owner=None, permissions=None, product=None, local_vars_configuration=None):  # noqa: E501
    ...
    def accessors(self, accessors):
        ...
        :type accessors: list[LicensePoolAccessPolicy]
        """
