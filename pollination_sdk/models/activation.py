...
class Activation(object):
    ...
    def __init__(self, app_version=None, created_at=None, hostname=None, id=None, last_synced_at=None, lease_expires_at=None, license_id=None, location=None, metadata=[], offline=None, os=None, os_version=None, updated_at=None, local_vars_configuration=None):  # noqa: E501
