...
class MetaData(object):
    ...
    def __init__(self, app_version=None, deprecated=None, description=None, home=None, icon=None, keywords=None, license=None, maintainers=None, name=None, sources=None, tag=None, local_vars_configuration=None):  # noqa: E501
