...
class QuotaType(object):
    ...
    allowable_values = [STORAGE, COMPUTE_HOURS, PARALLEL_WORKFLOW_CONTAINERS, PRIVATE_REPOSITORIES, PRIVATE_PROJECTS, TEAMS, MEMBERS, CPU_LIMIT, MEMORY_LIMIT]  # noqa: E501
