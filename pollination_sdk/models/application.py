...
class Application(object):
    ...
    def __init__(self, description='', id=None, image='https://picsum.photos/400', keywords=[], license=None, name=None, owner=None, permissions=None, public=True, slug=None, source=None, local_vars_configuration=None):  # noqa: E501
