...
class Application(object):
    ...
    attribute_map = {
        ...
        'has_been_deployed': 'has_been_deployed',
        'id': 'id',
        'image': 'image',
        'is_paid': 'is_paid',
        'keywords': 'keywords',
    ...
    def __init__(self, deployment_config=None, description='', has_been_deployed=None, id=None, image='https://picsum.photos/400', is_paid=False, keywords=[], license=None, name=None, owner=None, permissions=None, public=True, sdk=None, slug=None, source=None, url=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.has_been_deployed = has_been_deployed
        self.id = id
    ...
    @property
    def has_been_deployed(self):
        """Gets the has_been_deployed of this Application.  # noqa: E501

        Whether or not the application has been deployed  # noqa: E501

        :return: The has_been_deployed of this Application.  # noqa: E501
        :rtype: bool
        """
        return self._has_been_deployed

    @has_been_deployed.setter
    def has_been_deployed(self, has_been_deployed):
        """Sets the has_been_deployed of this Application.

        Whether or not the application has been deployed  # noqa: E501

        :param has_been_deployed: The has_been_deployed of this Application.  # noqa: E501
        :type has_been_deployed: bool
        """
        if self.local_vars_configuration.client_side_validation and has_been_deployed is None:  # noqa: E501
            raise ValueError("Invalid value for `has_been_deployed`, must not be `None`")  # noqa: E501

        self._has_been_deployed = has_been_deployed
