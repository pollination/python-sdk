...
class OrganizationMember(object):
    ...
    @property
    def user(self):
        """Gets the user of this OrganizationMember.  # noqa: E501

        The organization member  # noqa: E501

        :return: The user of this OrganizationMember.  # noqa: E501
        :rtype: UserPublic
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this OrganizationMember.

        The organization member  # noqa: E501

        :param user: The user of this OrganizationMember.  # noqa: E501
