...
class JobStatus(object):
    ...
    def __init__(self, annotations=None, api_version='v1beta1', finished_at=None, id=None, message=None, runs_completed=0, runs_failed=0, runs_pending=0, runs_running=0, source=None, started_at=None, status=None, type='JobStatus', local_vars_configuration=None):  # noqa: E501
