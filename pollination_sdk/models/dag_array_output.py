...
class DAGArrayOutput(object):
    ...
    def __init__(self, alias=None, annotations=None, description=None, _from=None, items_type=None, name=None, type='DAGArrayOutput', local_vars_configuration=None):  # noqa: E501
