...
class SubscriptionUpdate(object):
    ...
    def __init__(self, promotion_code=None, to_add=[], to_delete=[], to_subscribe=None, to_update=[], local_vars_configuration=None):  # noqa: E501
    ...
    def promotion_code(self):
        """Gets the promotion_code of this SubscriptionUpdate.  # noqa: E501

        A promotion code to apply a discount to the subscription  # noqa: E501

        :return: The promotion_code of this SubscriptionUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def promotion_code(self, promotion_code):
        """Sets the promotion_code of this SubscriptionUpdate.

        A promotion code to apply a discount to the subscription  # noqa: E501

        :param promotion_code: The promotion_code of this SubscriptionUpdate.  # noqa: E501
