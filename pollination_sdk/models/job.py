...
class Job(object):
    ...
    openapi_types = {
        ...
        'api_version': 'str',
        'arguments': 'list[list[AnyOfJobArgumentJobPathArgument]]',
        'description': 'str',
        'labels': 'dict(str, str)',
        'name': 'str',
        'source': 'str',
    ...
    def arguments(self):
        ...
        :rtype: list[list[AnyOfJobArgumentJobPathArgument]]
        """
    ...
    def arguments(self, arguments):
        ...
        :type arguments: list[list[AnyOfJobArgumentJobPathArgument]]
        """
