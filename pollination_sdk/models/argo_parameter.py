...
class ArgoParameter(object):
    ...
    @property
    def name(self):
        """Gets the name of this ArgoParameter.  # noqa: E501

        Name is the parameter name. must be unique within a task's inputs / outputs.  # noqa: E501

        :return: The name of this ArgoParameter.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ArgoParameter.

        Name is the parameter name. must be unique within a task's inputs / outputs.  # noqa: E501

        :param name: The name of this ArgoParameter.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this ArgoParameter.  # noqa: E501

        Default value to use for an input parameter if a value was not supplied.  # noqa: E501

        :return: The value of this ArgoParameter.  # noqa: E501
        :rtype: object
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this ArgoParameter.

        Default value to use for an input parameter if a value was not supplied.  # noqa: E501

        :param value: The value of this ArgoParameter.  # noqa: E501
        :type: object
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArgoParameter):
            return False
