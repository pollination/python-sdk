...
class SimulationStatus(object):
    ...
    def __init__(self, entrypoint=None, finished_at=None, id=None, message=None, owner_id=None, parallelism=None, project_id=None, recipe_id=None, recipe_owner_id=None, recipe_package_id=None, started_at=None, status=None, tasks=None, local_vars_configuration=None):  # noqa: E501
