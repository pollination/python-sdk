...
class InvoicePreview(object):
    ...
    def __init__(self, auto_advance=None, collection_method=None, currency=None, customer=None, description=None, hosted_invoice_url=None, lines=None, payment_method=None, period_end=None, period_start=None, status=None, status_transitions=None, subscription=None, total=None, local_vars_configuration=None):  # noqa: E501
