...
class InvoicePreview(object):
    ...
    def __init__(self, auto_advance=None, collection_method=None, currency=None, customer=None, description=None, discounts=[], hosted_invoice_url=None, lines=None, payment_method=None, period_end=None, period_start=None, status=None, status_transitions=None, subscription=None, subtotal=None, total=None, total_discount_amounts=[], local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def discounts(self):
        """Gets the discounts of this InvoicePreview.  # noqa: E501


        :return: The discounts of this InvoicePreview.  # noqa: E501
        :rtype: list[Discount]
        """
    ...
    def discounts(self, discounts):
        """Sets the discounts of this InvoicePreview.


        :param discounts: The discounts of this InvoicePreview.  # noqa: E501
