...
class Repository(object):
    ...
    def __init__(self, description=None, icon=None, id=None, keywords=None, latest_tag=None, name=None, owner=None, permissions=None, public=None, slug=None, local_vars_configuration=None):  # noqa: E501
