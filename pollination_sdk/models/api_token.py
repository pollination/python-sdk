...
class APIToken(object):
    ...
    def __init__(self, claims=None, name=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def claims(self):
        """Gets the claims of this APIToken.  # noqa: E501

        Key value pairs of auth claims the API token is entitled to  # noqa: E501

        :return: The claims of this APIToken.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._claims
    ...
    def claims(self, claims):
        """Sets the claims of this APIToken.

        Key value pairs of auth claims the API token is entitled to  # noqa: E501

        :param claims: The claims of this APIToken.  # noqa: E501
