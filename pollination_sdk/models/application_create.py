...
class ApplicationCreate(object):
    ...
    def __init__(self, description='', image='https://picsum.photos/400', keywords=[], license=None, name=None, public=True, source=None, local_vars_configuration=None):  # noqa: E501
