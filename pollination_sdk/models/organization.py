...
class Organization(object):
    ...
    def __init__(self, contact_email=None, description='', id=None, member_count=0, name=None, owner=None, picture=None, team_count=0, local_vars_configuration=None):  # noqa: E501
