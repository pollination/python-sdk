...
class Organization(object):
    ...
    def __init__(self, contact_email=None, description=None, id=None, member_count=0, name=None, owner=None, picture_url=None, role=None, team_count=0, local_vars_configuration=None):  # noqa: E501
