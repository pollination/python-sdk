...
class WorkflowDto(object):
    ...
    def __init__(self, type=None, name=None, id='8b84c025-d31d-4973-9658-d291ee667f76', inputs=None, operators=None, templates=None, flow=None, outputs=None, artifact_locations=None, public=None, owner=None, slug=None, permissions=None, local_vars_configuration=None):  # noqa: E501
