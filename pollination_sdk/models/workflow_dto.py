...
class WorkflowDto(object):
    ...
    def __init__(self, type=None, name=None, id='9c1692f8-d8c3-43df-9704-bb529f9aebb8', inputs=None, operators=None, templates=None, flow=None, outputs=None, artifact_locations=None, public=None, owner=None, slug=None, permissions=None, local_vars_configuration=None):  # noqa: E501
