...
class WorkflowDto(object):
    ...
    def __init__(self, type=None, name=None, id='483395fd-6e1e-4c14-89fe-66de4b627c6d', inputs=None, operators=None, templates=None, flow=None, outputs=None, artifact_locations=None, public=None, owner=None, slug=None, permissions=None, local_vars_configuration=None):  # noqa: E501
