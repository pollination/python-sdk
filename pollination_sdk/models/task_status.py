...
class TaskStatus(object):
    ...
    def __init__(self, status=None, message=None, started_at=None, finished_at=None, id=None, name=None, type=None, template_ref=None, command=None, inputs=None, outputs=None, boundary_id=None, children=None, outbound_tasks=None, local_vars_configuration=None):  # noqa: E501
