...
class Price(object):
    ...
    def __init__(self, active=None, currency=None, id=None, nickname=None, product=None, recurring=None, type=None, unit_amount=None, local_vars_configuration=None):  # noqa: E501
