...
class SimulationsApi(object):
    ...
    def create_simulation(self, owner, name, unknown_base_type, **kwargs):  # noqa: E501
        """Schedule a simulation  # noqa: E501

        Create a new simulation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_simulation(owner, name, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_simulation_with_http_info(owner, name, unknown_base_type, **kwargs)  # noqa: E501

    def create_simulation_with_http_info(self, owner, name, unknown_base_type, **kwargs):  # noqa: E501
        """Schedule a simulation  # noqa: E501

        Create a new simulation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_simulation_with_http_info(owner, name, unknown_base_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['owner', 'name', 'unknown_base_type']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('unknown_base_type' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `unknown_base_type` when calling `create_simulation`")  # noqa: E501
    ...
    def list_simulations(self, owner, name, **kwargs):  # noqa: E501
        ...
        :param list[str] workflow: The ID of the workflow used for this simulation
    ...
    def list_simulations_with_http_info(self, owner, name, **kwargs):  # noqa: E501
        ...
        all_params = ['owner', 'name', 'page', 'per_page', 'id', 'workflow', 'status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'workflow' in local_var_params and local_var_params['workflow'] is not None:  # noqa: E501
            query_params.append(('workflow', local_var_params['workflow']))  # noqa: E501
            collection_formats['workflow'] = 'multi'  # noqa: E501
    ...
    def resubmit_simulation(self, owner, name, simulation_id, **kwargs):  # noqa: E501
        """re-submit a simulation  # noqa: E501

        re-submit a simulation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resubmit_simulation(owner, name, simulation_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.resubmit_simulation_with_http_info(owner, name, simulation_id, **kwargs)  # noqa: E501

    def resubmit_simulation_with_http_info(self, owner, name, simulation_id, **kwargs):  # noqa: E501
        """re-submit a simulation  # noqa: E501

        re-submit a simulation  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resubmit_simulation_with_http_info(owner, name, simulation_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resubmit_simulation" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `resubmit_simulation`")  # noqa: E501
        # verify the required parameter 'name' is set
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `name` when calling `resubmit_simulation`")  # noqa: E501
        # verify the required parameter 'simulation_id' is set
        if self.api_client.client_side_validation and ('simulation_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['simulation_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `simulation_id` when calling `resubmit_simulation`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/projects/{owner}/{name}/simulations/{simulation_id}/re-submit', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
