...
class SimulationsApi(object):
    ...
    def create_simulation(self, owner, name, submit_simulation_dto, **kwargs):  # noqa: E501
        ...
        :param name: (required)
        :type name: str
        :param submit_simulation_dto: (required)
        :type submit_simulation_dto: SubmitSimulationDto
        :param authorization:
    ...
    def get_simulation_with_http_info(self, owner, name, simulation_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SimulationStatus, status_code(int), headers(HTTPHeaderDict))
        """
