...
class SubscriptionsApi(object):
    ...
    def get_upcoming_pollination_subscription(self, account_name, **kwargs):  # noqa: E501
        """Get Upcoming Subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_upcoming_pollination_subscription(account_name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_upcoming_pollination_subscription_with_http_info(account_name, **kwargs)  # noqa: E501

    def get_upcoming_pollination_subscription_with_http_info(self, account_name, **kwargs):  # noqa: E501
        """Get Upcoming Subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_upcoming_pollination_subscription_with_http_info(account_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_upcoming_pollination_subscription" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'account_name' is set
        if self.api_client.client_side_validation and ('account_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['account_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `account_name` when calling `get_upcoming_pollination_subscription`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/subscriptions/{account_name}/upcoming', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
