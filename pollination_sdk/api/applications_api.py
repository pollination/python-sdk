...
class ApplicationsApi(object):
    ...
    def list_applications(self, **kwargs):  # noqa: E501
        ...
        :type public: bool
        :param deployed: Filter by deployed applications
        :type deployed: bool
    ...
    def list_applications_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'deployed' in local_var_params and local_var_params['deployed'] is not None:  # noqa: E501
            query_params.append(('deployed', local_var_params['deployed']))  # noqa: E501
    ...
    def restart_application_deployment(self, owner, slug, **kwargs):  # noqa: E501
        """Restart application deployment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.restart_application_deployment(owner, slug, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.restart_application_deployment_with_http_info(owner, slug, **kwargs)  # noqa: E501

    def restart_application_deployment_with_http_info(self, owner, slug, **kwargs):  # noqa: E501
        """Restart application deployment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.restart_application_deployment_with_http_info(owner, slug, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method restart_application_deployment" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `restart_application_deployment`")  # noqa: E501
        # verify the required parameter 'slug' is set
        if self.api_client.client_side_validation and ('slug' not in local_var_params or  # noqa: E501
                                                        local_var_params['slug'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `slug` when calling `restart_application_deployment`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/applications/{owner}/{slug}/deployment', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
