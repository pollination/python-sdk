...
class UserApi(object):
    ...
    def get_me_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PrivateUserDto, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_refresh_tokens_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[RefreshTokenDto], status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def upsert_refresh_token(self, create_token_dto, **kwargs):  # noqa: E501
        ...
        :param create_token_dto: (required)
        :type create_token_dto: CreateTokenDto
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
