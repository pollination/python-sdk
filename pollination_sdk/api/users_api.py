...
class UsersApi(object):
    ...
    def get_one_user_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PublicUserDto, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def list_users(self, **kwargs):  # noqa: E501
        ...
        :type username: str
        :param id: A list of users to search for by their user ID
        :type id: list[str]
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def list_users_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[PublicUserDto], status_code(int), headers(HTTPHeaderDict))
        """
