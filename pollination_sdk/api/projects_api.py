...
class ProjectsApi(object):
    ...
    def get_project_recipe_repositories(self, owner, name, **kwargs):  # noqa: E501
        """Get project recipe repositories  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_project_recipe_repositories(owner, name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_project_recipe_repositories_with_http_info(owner, name, **kwargs)  # noqa: E501

    def get_project_recipe_repositories_with_http_info(self, owner, name, **kwargs):  # noqa: E501
        """Get project recipe repositories  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_project_recipe_repositories_with_http_info(owner, name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_project_recipe_repositories" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `get_project_recipe_repositories`")  # noqa: E501
        # verify the required parameter 'name' is set
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `name` when calling `get_project_recipe_repositories`")  # noqa: E501

        if self.api_client.client_side_validation and 'page' in local_var_params and local_var_params['page'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page` when calling `get_project_recipe_repositories`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `get_project_recipe_repositories`, must be a value less than or equal to `100`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/projects/{owner}/{name}/recipes/repositories', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_project_recipes(self, owner, name, **kwargs):  # noqa: E501
        """Get project recipe versions  # noqa: E501
