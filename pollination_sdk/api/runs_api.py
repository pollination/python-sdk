...
class RunsApi(object):
    ...
    def get_all_run_steps(self, owner, name, run_id, **kwargs):  # noqa: E501
        """Query the steps of a run  # noqa: E501

        list all run steps  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_all_run_steps(owner, name, run_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: list[StepStatus]
        """
        kwargs['_return_http_data_only'] = True
        return self.get_all_run_steps_with_http_info(owner, name, run_id, **kwargs)  # noqa: E501

    def get_all_run_steps_with_http_info(self, owner, name, run_id, **kwargs):  # noqa: E501
        """Query the steps of a run  # noqa: E501
        ...
        >>> thread = api.get_all_run_steps_with_http_info(owner, name, run_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[StepStatus], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_run_steps" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'owner' is set
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `get_all_run_steps`")  # noqa: E501
        # verify the required parameter 'name' is set
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `name` when calling `get_all_run_steps`")  # noqa: E501
        # verify the required parameter 'run_id' is set
        if self.api_client.client_side_validation and ('run_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['run_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `run_id` when calling `get_all_run_steps`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/projects/{owner}/{name}/runs/{run_id}/all-steps', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[StepStatus]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_run_artifacts_with_http_info(self, owner, name, run_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 10000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `list_run_artifacts`, must be a value less than or equal to `10000`")  # noqa: E501
        collection_formats = {}
    ...
    def retry_run(self, owner, name, run_id, retry_config, **kwargs):  # noqa: E501
        ...
        >>> thread = api.retry_run(owner, name, run_id, retry_config, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.retry_run_with_http_info(owner, name, run_id, retry_config, **kwargs)  # noqa: E501

    def retry_run_with_http_info(self, owner, name, run_id, retry_config, **kwargs):  # noqa: E501
        """Retry a run  # noqa: E501
        ...
        >>> thread = api.retry_run_with_http_info(owner, name, run_id, retry_config, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('owner' not in local_var_params or  # noqa: E501
                                                        local_var_params['owner'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `owner` when calling `retry_run`")  # noqa: E501
        # verify the required parameter 'name' is set
        if self.api_client.client_side_validation and ('name' not in local_var_params or  # noqa: E501
                                                        local_var_params['name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `name` when calling `retry_run`")  # noqa: E501
        # verify the required parameter 'run_id' is set
        if self.api_client.client_side_validation and ('run_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['run_id'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('retry_config' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `retry_config` when calling `retry_run`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/projects/{owner}/{name}/runs/{run_id}/retry', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
