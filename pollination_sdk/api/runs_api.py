...
class RunsApi(object):
    ...
    def retry_run(self, owner, name, run_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.retry_run(owner, name, run_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.retry_run_with_http_info(owner, name, run_id, **kwargs)  # noqa: E501

    def retry_run_with_http_info(self, owner, name, run_id, **kwargs):  # noqa: E501
        """Retry a run  # noqa: E501
        ...
        >>> thread = api.retry_run_with_http_info(owner, name, run_id, async_req=True)
        >>> result = thread.get()
