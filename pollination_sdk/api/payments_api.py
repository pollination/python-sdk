...
class PaymentsApi(object):
    ...
    def delete_payment_method(self, account_name, id, **kwargs):  # noqa: E501
        """Delete Payment Method  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_payment_method(account_name, id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_payment_method_with_http_info(account_name, id, **kwargs)  # noqa: E501

    def delete_payment_method_with_http_info(self, account_name, id, **kwargs):  # noqa: E501
        """Delete Payment Method  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_payment_method_with_http_info(account_name, id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('account_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['account_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `account_name` when calling `delete_payment_method`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/payments/{account_name}/methods/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_upcoming_subscription(self, account_name, **kwargs):  # noqa: E501
        """Get Upcoming Subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_upcoming_subscription(account_name, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_upcoming_subscription_with_http_info(account_name, **kwargs)  # noqa: E501

    def get_upcoming_subscription_with_http_info(self, account_name, **kwargs):  # noqa: E501
        """Get Upcoming Subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_upcoming_subscription_with_http_info(account_name, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_upcoming_subscription" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'account_name' is set
        if self.api_client.client_side_validation and ('account_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['account_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `account_name` when calling `get_upcoming_subscription`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/payments/{account_name}/subscription/upcoming', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_payment_method(self, account_name, id, update_payment_method, **kwargs):  # noqa: E501
        """Update Payment Method  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_payment_method(account_name, id, update_payment_method, async_req=True)
        >>> result = thread.get()
        ...
        :param id: (required)
        :type id: str
        :param update_payment_method: (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_payment_method_with_http_info(account_name, id, update_payment_method, **kwargs)  # noqa: E501

    def update_payment_method_with_http_info(self, account_name, id, update_payment_method, **kwargs):  # noqa: E501
        """Update Payment Method  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_payment_method_with_http_info(account_name, id, update_payment_method, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('account_name' not in local_var_params or  # noqa: E501
                                                        local_var_params['account_name'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `account_name` when calling `update_payment_method`")  # noqa: E501
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `update_payment_method`")  # noqa: E501
        # verify the required parameter 'update_payment_method' is set
        if self.api_client.client_side_validation and ('update_payment_method' not in local_var_params or  # noqa: E501
                                                        local_var_params['update_payment_method'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `update_payment_method` when calling `update_payment_method`")  # noqa: E501
        ...
        body_params = None
        if 'update_payment_method' in local_var_params:
            body_params = local_var_params['update_payment_method']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/payments/{account_name}/methods/{id}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
